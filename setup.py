...
setup(
    name='tendril-tx-streamreactor',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Primitives and Utilities for Twisted Stream Reactors for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-tx-streamreactor',
    project_urls={
        'Documentation': 'https://tendril-tx-streamreactor.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-tx-streamreactor/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-tx-streamreactor',
    },
